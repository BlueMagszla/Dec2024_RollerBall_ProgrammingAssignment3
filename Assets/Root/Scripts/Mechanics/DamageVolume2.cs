...
public class DamageVolume2 : MonoBehaviour, IDamager<int>
{
    [SerializeField]
    ...
    protected virtual void OnTriggerEnter(Collider other)
    {
        ...
        TryDamage(gameObject);
        gameObject.GetComponent<BoxCollider>().enabled = false; //modified for to be on the volume inside the player 
    }
